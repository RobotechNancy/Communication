...
#define CAN_MAX_VALUE_REP_NBR     1
...
#define ADDR_LIST (int[]) {CAN_ADDR_RASPBERRY, CAN_ADDR_BASE_ROULANTE, CAN_ADDR_ODOMETRIE, CAN_ADDR_ACTIONNEUR,CAN_ADDR_BROADCAST, \
						   CAN_ADDR_RASPBERRY_E, CAN_ADDR_BASE_ROULANTE_E, CAN_ADDR_ODOMETRIE_E, CAN_ADDR_ACTIONNEUR_E, CAN_ADDR_BROADCAST_E}
...
typedef enum {
	...
	FCT_TEST_COMM =                     0x08000,
    FCT_GET_OPTIQUE =                   0xa1000,
} CAN_FCT_CODE;


#define FCT_CODE_LIST (int[]) {FCT_AVANCE, FCT_CHANGEMENT_ETAT, FCT_GET_OPTIQUE}
